...
function gainedInfinityPoints() {
    ...
    if (player.achievements.includes("r43")) ret = ret.times(1.25)
    if (player.achievements.includes("r55")) ret = ret.times(Math.pow(Math.log10(6000/player.bestInfinityTime),0.1).min(1))
